...
```
PS C:\Users\dave> Get-ChildItem -Path C:\ -Include nc.exe -File -Recurse -ErrorAction SilentlyContinue
...
```
kali@kali:~$ cp /usr/share/windows-resources/powersploit/Privesc/cdPowerUp.ps1 .
...
No encoder specified, outputt payload
